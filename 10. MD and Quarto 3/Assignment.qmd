...
season_file <- paste0("C:/Users/MI/Desktop/RR25/RRcourse2025/10. MD and Quarto 3/Data/season_", params$season, ".csv")
season_data <- read.csv(season_file)
```

### Season `r params$season` Summary

Season `r params$season` of Game of Thrones consisted of `r nrow(season_data)` episodes...
